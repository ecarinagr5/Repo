...
class Interior301 extends Component {
    constructor(props) {
        super(props);
        this.state = {
   ...
   render() { 
    const rutaBase = '/'; /*Para prod debe ir / */ 
      return (
        <div id="body-container" className="backgroundblack pullDown">
            <div className="maxWidthAvailable">
            <div id="car208" className="interior-container pullDown">
                <div className="video-background">
                    <div className="video-foreground">
                        <iframe src="https://www.youtube.com/embed/ujq2FQ_6Ilo?controls=1&showinfo=0&rel=0&autoplay=1&loop=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen />
                    </div>
                </div>               
                    <Menu />
                ...
                <div id="iconsInfo" >
                    ...
                    <div id="info-tres" className="icons-content slideRight">
                        <Link to="/Peugeot301"> <img src={ rutaBase + this.state.colorcar[0] } alt="Peugeot 301" /> </Link>
                        <Link to="/Peugeot301"> <img src={ rutaBase + this.state.colorcar[1] } alt="Peugeot 301" /></Link>
                        <Link to="/Peugeot301"> <img src={ rutaBase + this.state.colorcar[2] } alt="Peugeot 301" /></Link>
                        <Link to="/Peugeot301"> <img src={ rutaBase + this.state.colorcar[3] } alt="Peugeot 301" /></Link>
                    </div>
                    </div>
                    </div>
                </div>
