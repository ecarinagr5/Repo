        ...
        <div id="body-container" className={`${ window.location.href === path +  '/Peugeot-Exterior-208' ? 'background208' : ''}`}>
            <div className="maxWidthAvailable">
                ...
                <div id="car208" className="exterior208-container pullDown">
                    <img id="car-uno" className="carImageExterior slideCar" src={ rutaBase + this.state.Car208[2]} alt="Peogeut 208" />
                    <img id="car-tres" className="carImageExterior slideCar" src={ rutaBase + this.state.Car208[0]}  alt="Peogeut 208" />
                    <img id="car-dos" className="carImageExterior slideCar" src={ rutaBase + this.state.Car208[1]} alt="Peogeut 208" />
                    <img id="car-cuatro" className="carImageExterior slideCar" src={ rutaBase + this.state.Car208[3]} alt="Peogeut 208" />
                    <Menu />
